...
1. Clone the repository : `git clone https://github.com/GreenGlasses16/lung-cancer-prediction.git`

2. Navigate to the project directory : `cd lung-cancer-prediction`
